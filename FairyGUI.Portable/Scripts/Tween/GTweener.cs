	...
	public class GTweener
	{
		...
		void CallStartCallback()
		{
			if (GTween.catchCallbackExceptions)
			{
				...
				{
					Log.Warning("FairyGUI: error in start callback > " + e.Message);
				}
			}
			else
			{
		...
		void CallUpdateCallback()
		{
			if (GTween.catchCallbackExceptions)
			{
				...
				{
					Log.Warning("FairyGUI: error in update callback > " + e.Message);
				}
			}
			else
			{
		...
		void CallCompleteCallback()
		{
			if (GTween.catchCallbackExceptions)
			{
				...
				{
					Log.Warning("FairyGUI: error in complete callback > " + e.Message);
				}
			}
			else
			{
